...
#pragma HLS INTERFACE mode=m_axi port=matrix_in_2 bundle=data1
...
#pragma HLS BIND_STORAGE variable=matrix2 type=ram_2p impl=bram
#pragma HLS BIND_STORAGE variable=matrix1 type=ram_2p impl=bram
...
#pragma HLS BIND_STORAGE variable=Matrix_4x4_final type=ram_2p
