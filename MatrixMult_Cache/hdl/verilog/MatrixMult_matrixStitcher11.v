...
module MatrixMult_matrixStitcher11 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
MatrixMult_mac_muladd_16ns_13ns_13ns_29_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 13 ),
    .din2_WIDTH( 13 ),
    .dout_WIDTH( 29 ))
mac_muladd_16ns_13ns_13ns_29_4_1_U206(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_474_p0),
    .din1(grp_fu_474_p1),
...
MatrixMult_ama_addmuladd_13ns_1ns_16ns_13ns_29_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 13 ),
    .din1_WIDTH( 1 ),
    ...
    .din3_WIDTH( 13 ),
    .dout_WIDTH( 29 ))
ama_addmuladd_13ns_1ns_16ns_13ns_29_4_1_U207(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_482_p0),
    .din1(grp_fu_482_p1),
...
MatrixMult_ama_addmuladd_13ns_2ns_16ns_13ns_30_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 13 ),
    .din1_WIDTH( 2 ),
    ...
    .din3_WIDTH( 13 ),
    .dout_WIDTH( 30 ))
ama_addmuladd_13ns_2ns_16ns_13ns_30_4_1_U208(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_490_p0),
    .din1(grp_fu_490_p1),
...
MatrixMult_ama_addmuladd_13ns_2ns_16ns_13ns_30_4_1 #(
    ...
    .din3_WIDTH( 13 ),
    .dout_WIDTH( 30 ))
ama_addmuladd_13ns_2ns_16ns_13ns_30_4_1_U209(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_499_p0),
    .din1(grp_fu_499_p1),
...
endmodule //MatrixMult_matrixStitcher11
